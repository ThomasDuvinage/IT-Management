...
public class MainController extends Controller implements Initializable {
	...
	public void addComputerStation(ActionEvent event) throws IOException {
		...
		add_station_loader.setController(new AddStationController(this.screen_controller, this.model_it_bdd));
	...
	private void updateTreeTable(List<ComputerStation> cs) {
		...
		for (ComputerStation computerStation : cs) {
			itemRoot = new TreeItem<Component>(computerStation, new ImageView(new Image("file:../../img/Station_16.png")));
			this.TreeTableMaterial.getRoot().getChildren().add(itemRoot);

			for (Component component : computerStation.getComponents()) {
				TreeItem<Component> itemComponent = new TreeItem<Component>(component, new ImageView(new Image("file:../../img/Keyboard_16.png")));
